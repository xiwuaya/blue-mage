...
//# sourceURL=webpack://CafeKitCommon/./lib/styles/main.styl?`)}})},module.exports=factory()},function(e,t,n){var o,r=this&&this.__extends||(o=function(y,k){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(m,v){m.__proto__=v}||function(m,v){for(var g in v)v.hasOwnProperty(g)&&(m[g]=v[g])})(y,k)},function(y,k){function m(){this.constructor=y}o(y,k),y.prototype=k===null?Object.create(k):(m.prototype=k.prototype,new m)}),l=this&&this.__assign||function(){return(l=Object.assign||function(y){for(var k,m=1,v=arguments.length;m<v;m++)for(var g in k=arguments[m])Object.prototype.hasOwnProperty.call(k,g)&&(y[g]=k[g]);return y}).apply(this,arguments)},a=this&&this.__awaiter||function(y,k,m,v){return new(m||(m=Promise))(function(g,A){function x(S){try{j(v.next(S))}catch(O){A(O)}}function P(S){try{j(v.throw(S))}catch(O){A(O)}}function j(S){S.done?g(S.value):new m(function(O){O(S.value)}).then(x,P)}j((v=v.apply(y,k||[])).next())})},s=this&&this.__generator||function(y,k){var m,v,g,A,x={label:0,sent:function(){if(1&g[0])throw g[1];return g[1]},trys:[],ops:[]};return A={next:P(0),throw:P(1),return:P(2)},typeof Symbol=="function"&&(A[Symbol.iterator]=function(){return this}),A;function P(j){return function(S){return function(O){if(m)throw new TypeError("Generator is already executing.");for(;x;)try{if(m=1,v&&(g=2&O[0]?v.return:O[0]?v.throw||((g=v.return)&&g.call(v),0):v.next)&&!(g=g.call(v,O[1])).done)return g;switch(v=0,g&&(O=[2&O[0],g.value]),O[0]){case 0:case 1:g=O;break;case 4:return x.label++,{value:O[1],done:!1};case 5:x.label++,v=O[1],O=[0];continue;case 7:O=x.ops.pop(),x.trys.pop();continue;default:if(!(g=(g=x.trys).length>0&&g[g.length-1])&&(O[0]===6||O[0]===2)){x=0;continue}if(O[0]===3&&(!g||O[1]>g[0]&&O[1]<g[3])){x.label=O[1];break}if(O[0]===6&&x.label<g[1]){x.label=g[1],g=O;break}if(g&&x.label<g[2]){x.label=g[2],x.ops.push(O);break}g[2]&&x.ops.pop(),x.trys.pop();continue}O=k.call(y,x)}catch(q){O=[6,q],v=0}finally{m=g=0}if(5&O[0])throw O[1];return{value:O[0]?O[1]:void 0,done:!0}}([j,S])}}};Object.defineProperty(t,"__esModule",{value:!0});var i=n(0),c=n(2),f=function(y){function k(){return y!==null&&y.apply(this,arguments)||this}return r(k,y),k.prototype.componentDidMount=function(){return a(this,void 0,void 0,function(){return s(this,function(m){switch(m.label){case 0:return[4,this.getData()];case 1:return m.sent(),[2]}})})},k.prototype.componentDidUpdate=function(m){return a(this,void 0,void 0,function(){var v;return s(this,function(g){switch(g.label){case 0:if(this.props.onUpdate&&this.props.onUpdate(),m.id===this.props.id&&m.name===this.props.name&&m.jobId===this.props.jobId)return[3,4];this.setState({data:null,error:null}),g.label=1;case 1:return g.trys.push([1,3,,4]),[4,this.getData()];case 2:return g.sent(),[3,4];case 3:return v=g.sent(),this.setState({error:v}),console.error(v),[3,4];case 4:return[2]}})})},k.prototype.getData=function(){return a(this,void 0,void 0,function(){var m,v;return s(this,function(g){switch(g.label){case 0:return[4,this.getId()];case 1:return(m=g.sent())?[4,fetch(this.context.apiBaseUrl+"/Action/"+m+"?columns=Icon,Name,Description,ActionCategory.Name,ClassJob.Name,MaxCharges,Range,Cast100ms,Recast100ms,ClassJobLevel,EffectRange,ClassJobCategory.Name")]:[2];case 2:return[4,g.sent().json()];case 3:return v=g.sent(),this.setState({data:v}),[2]}})})},k.prototype.getId=function(){return a(this,void 0,void 0,function(){var m,v,g;return s(this,function(A){switch(A.label){case 0:return this.props.id&&(m=parseInt(""+this.props.id),!isNaN(m))?[2,m]:this.props.name?(v=this.context.apiBaseUrl+"/search?indexes=Action&limit=1&string="+encodeURIComponent(this.props.name)+"&filters=ClassJobLevel>0,IsPvP="+(this.props.pvp?"1":"0"),this.props.jobId&&(v=v+",ClassJobTargetID="+this.props.jobId),[4,fetch(v)]):(this.setState({error:"\u6CA1\u6709\u6307\u5B9A\u6280\u80FD\u540D\u5B57\u6216 ID\u3002"}),[2,null]);case 1:return[4,A.sent().json()];case 2:return(g=A.sent()).Results[0]?[2,g.Results[0].ID]:(this.setState({error:"\u6CA1\u6709\u627E\u5230\u6280\u80FD\u201C"+this.props.name+"\u201D\u3002"}),[2,null])}})})},k.prototype.render=function(){if(this.state.error)return i.h(c.CKBox,null,i.h(c.CKContainer,null,this.state.error));if(!this.state.data)return i.h(c.CKBox,null,i.h(c.CKContainer,null,"Loading..."));var m=this.state.data,v=m.Icon,g=m.Name,A=m.Description,x=m.ActionCategory.Name,P=m.ClassJob.Name,j=m.ClassJobCategory.Name,S=m.MaxCharges,O=m.Range,q=m.Cast100ms,N=m.Recast100ms,W=m.ClassJobLevel,ee=m.EffectRange,re=P||j,z=["\u821E\u8005","\u541F\u6E38\u8BD7\u4EBA","\u5F13\u7BAD\u624B","\u673A\u5DE5\u58EB"].indexOf(re)>-1?25:3,ne=O<0?z:O,le={attrs:[]};le.attrs.push({name:"\u8303\u56F4",value:ee+"m",style:"half"}),le.attrs.push({name:"\u8DDD\u79BB",value:ne+"m",style:"half"}),le.attrs.push({name:"\u4E60\u5F97\u7B49\u7EA7",value:re+" "+W+"\u7EA7",style:"half-full"}),S&&le.attrs.push({name:"\u5145\u80FD\u5C42\u6570",value:S,style:"half-full"});var ue=""+this.context.iconBaseUrl+v.replace(/^\/i/,""),Q=i.h("div",{dangerouslySetInnerHTML:{__html:A.replace(/\n/g,"<br/>")}}),$=new Date().getFullYear();return i.h(c.CKBox,null,i.h("div",{style:{width:320,padding:8}},i.h(c.CKContainer,{style:{paddingBottom:0}},i.h(c.CKItemName,{name:g,rarity:0,type:x,size:"medium",iconSrc:ue})),i.h("div",{style:{paddingTop:6}},i.h(c.CKStatGroup,null,i.h(c.CKStat,{name:"\u548F\u5531\u65F6\u95F4",value:b(q)}),i.h(c.CKStat,{name:"\u590D\u5531\u65F6\u95F4",value:b(N)}))),i.h(c.CKContainer,null,Q),i.h(c.CKContainer,null,i.h(c.CKAttributes,l({},le))),i.h(c.CKComment,null,i.h("p",{style:{fontSize:"9px",textAlign:"right",opacity:.6,userSelect:"none"}},this.context.hideSeCopyright?null:"\xA9 "+$+" SQUARE ENIX CO., LTD. ","Powered by"," ",i.h("a",{href:"https://ffcafe.org/?utm_source=ckitem",target:"_blank",rel:"noopener noreferrer"},"FFCafe")))))},k}(i.Component);function b(y){return y===0?"\u5373\u65F6":y/10+"\u79D2"}t.CKAction=f},function(e,t,n){var o,r=this&&this.__extends||(o=function(s,i){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,f){c.__proto__=f}||function(c,f){for(var b in f)f.hasOwnProperty(b)&&(c[b]=f[b])})(s,i)},function(s,i){function c(){this.constructor=s}o(s,i),s.prototype=i===null?Object.create(i):(c.prototype=i.prototype,new c)});Object.defineProperty(t,"__esModule",{value:!0});var l=n(0),a=function(s){function i(){return s!==null&&s.apply(this,arguments)||this}return r(i,s),i.prototype.getChildContext=function(){return this.props},i.prototype.render=function(){return l.h("div",null,this.props.children)},i}(l.Component);t.CKContextProvider=a},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=n(1);t.CKItem=o.CKItem;var r=n(3);t.CKAction=r.CKAction;var l=n(4);t.CKContextProvider=l.CKContextProvider;var a=n(9);t.initTooltip=a.initTooltip;var s=n(0);t.render=s.render,t.h=s.h},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0}),t.copyText=function(o){var r=document.createElement("textarea");r.value=o,r.style.width="0",r.style.height="0",r.style.opacity="0",r.style.position="absolute",document.body.appendChild(r),r.select(),document.execCommand("copy")||prompt("\u8BF7\u624B\u52A8\u590D\u5236\u4EE5\u4E0B\u5185\u5BB9",o),document.body.removeChild(r)}},function(e,t,n){var o,r=this&&this.__extends||(o=function(i,c){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(f,b){f.__proto__=b}||function(f,b){for(var y in b)b.hasOwnProperty(y)&&(f[y]=b[y])})(i,c)},function(i,c){function f(){this.constructor=i}o(i,c),i.prototype=c===null?Object.create(c):(f.prototype=c.prototype,new f)});Object.defineProperty(t,"__esModule",{value:!0});var l=n(0),a=n(8),s=function(i){function c(){var f=i!==null&&i.apply(this,arguments)||this;return f.handleHqClick=function(){f.props.onHqChange(!f.props.hq)},f.preventSelectText=function(b){b.preventDefault(),b.stopPropagation()},f}return r(c,i),c.prototype.render=function(){var f={cursor:"pointer",userSelect:"none"};return this.props.hq||(f.opacity=.2),l.h("span",{style:f,onClick:this.handleHqClick,onMouseDown:this.preventSelectText}," ",a.hqSvg)},c}(l.Component);t.HqButton=s},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=n(0);t.hqSvg=o.h("svg",{width:"12",height:"12",viewBox:"0 0 64 67",fill:"none",xmlns:"http://www.w3.org/2000/svg"},o.h("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M41.1148 9.7149C50.538 9.7149 58.8813 14.3384 64 21.4405C59.3004 8.91467 47.2153 0 33.048 0C14.7961 0 0 14.7961 0 33.048C0 51.2999 14.7961 66.0959 33.048 66.0959C34.469 66.0959 35.8691 66.0062 37.2428 65.8322C33.4767 65.3149 29.9478 64.0537 26.8091 62.2016C25.2784 60.1233 24.3739 57.5554 24.3739 54.7763C24.3739 47.854 29.9856 42.2424 36.9079 42.2424C43.4076 42.2424 48.7518 47.1898 49.3801 53.5242C50.0936 51.5602 50.4827 49.4405 50.4827 47.23C50.4827 37.0501 42.2303 28.7977 32.0504 28.7977C22.6912 28.7977 14.9612 35.7732 13.7757 44.8089C13.2197 42.5998 12.9243 40.2871 12.9243 37.9054C12.9243 22.3362 25.5456 9.7149 41.1148 9.7149Z",fill:"white"}))},function(e,t,n){var o=this&&this.__assign||function(){return(o=Object.assign||function(c){for(var f,b=1,y=arguments.length;b<y;b++)for(var k in f=arguments[b])Object.prototype.hasOwnProperty.call(f,k)&&(c[k]=f[k]);return c}).apply(this,arguments)};Object.defineProperty(t,"__esModule",{value:!0});var r=n(10),l=n(11),a=n(12),s={context:{apiBaseUrl:"https://cafemaker.wakingsands.com",iconBaseUrl:"https://cafemaker.wakingsands.com/i",defaultHq:!0,hideSeCopyright:!1},links:{detectWikiLinks:!0,itemNameAttribute:"data-ck-item-name",itemIdAttribute:"data-ck-item-id",actionNameAttribute:"data-ck-action-name",actionIdAttribute:"data-ck-action-id",rootContainer:document.body}},i=!!r.isSupportPassive()&&{passive:!0};t.initTooltip=function(c){c===void 0&&(c={});var f={context:o({},s.context,c.context||{}),links:o({},s.links,c.links||{})},b=function(y){return function(k){var m,v="item";if((y.links.itemIdAttribute||y.links.itemNameAttribute)&&(m=m||function(x,P){var j=l.closest(x,"["+P.links.itemNameAttribute+"]"),S=l.closest(x,"["+P.links.itemIdAttribute+"]");if(S)return{props:{id:S.getAttribute(P.links.itemIdAttribute)},element:S};if(j){var O=j.getAttribute(P.links.itemNameAttribute)||j.innerText.trim();return{props:{name:O},element:j}}return null}(k.target,y)),y.links.detectWikiLinks&&(m=m||function(x){var P=l.closest(x,"a");if(!P||P.host!=="ff14.huijiwiki.com")return null;var j=P.pathname.match(/^\/wiki\/(.*)$/);if(!j)return null;var S=decodeURIComponent(j[1]).split(":"),O=S[0],q=S[1];return O!=="\u7269\u54C1"&&O.toLowerCase()!=="item"?null:{props:{name:q},element:P}}(k.target)),y.links.actionIdAttribute||y.links.actionNameAttribute){var g=function(x,P){var j=l.closest(x,"["+P.links.actionNameAttribute+"]"),S=l.closest(x,"["+P.links.actionIdAttribute+"]");if(S)return{props:{id:S.getAttribute(P.links.actionIdAttribute)},element:S};if(j){var O=j.getAttribute("data-ck-action-job-id")||null,q=j.getAttribute(P.links.actionNameAttribute)||j.innerText.trim();return{props:{name:q,jobId:O},element:j}}return null}(k.target,y);g&&(v="action",m=g)}if(m&&(v==="item"?a.popupItem(y.context,m.props,m.element):a.popupAction(y.context,m.props,m.element),m.element.__ckflag_leave!==!0)){var A=function(){a.hidePopup(),m.element.removeEventListener("mouseleave",A),delete m.element.__ckflag_leave};m.element.addEventListener("mouseleave",A,i),function(x,P){x["__ckflag_"+P]=!0}(m.element,"leave")}}}(f);f.links.rootContainer.addEventListener("mouseover",b,i)}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=null;t.isSupportPassive=function(){if(o!==null)return o;if(typeof window!="undefined"&&typeof window.addEventListener=="function"){var r=!1,l=Object.defineProperty({},"passive",{get:function(){r=!0}}),a=function(){};return window.addEventListener("testPassiveEventSupport",a,l),window.removeEventListener("testPassiveEventSupport",a,l),o=r,r}}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0}),t.closest=function(o,r){if(typeof r=="string")try{document.createElement("div").querySelector(r)}catch{return null}var l=o;do{if(r instanceof HTMLElement){if(l===r)return l}else if(l.matches(r))return l;l=l.parentElement}while(l);return null}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o,r,l=n(0),a=n(1),s=n(3),i=n(4),c=document.createElement("div");c.style.position="fixed",c.style.display="none",c.className="cafekit ck-popup";var f=function(){setTimeout(y,100)};function b(){clearTimeout(o),o=setTimeout(function(){return c.style.display="none"},300)}function y(){var m=r.getBoundingClientRect(),v=window.innerWidth,g=window.innerHeight,A=c.getBoundingClientRect(),x={left:m.right+15,top:m.bottom+10,bottom:void 0},P=A.width,j=A.height;for(var S in x.left+P>v&&(x.left=Math.max(0,v-P)),x.top+j>g&&(x.top=void 0,x.bottom=10),x)c.style[S]=x[S]==null?"":x[S]+"px"}function k(m){r=m;var v=c;y(),v.style.display="block",v.parentElement||document.body.appendChild(v)}t.popupItem=function(m,v,g){clearTimeout(o),v.onUpdate=f,l.render(l.h(i.CKContextProvider,m,[l.h(a.CKItem,v)]),c,c.children&&c.children[0]),k(g)},t.popupAction=function(m,v,g){clearTimeout(o),v.onUpdate=f,l.render(l.h(i.CKContextProvider,m,[l.h(s.CKAction,v)]),c,c.children&&c.children[0]),k(g)},t.hidePopup=b,c.addEventListener("mouseenter",function(){return clearTimeout(o)}),c.addEventListener("mouseleave",function(){return b()})}])})})(bundle);createApp(_sfc_main).mount("#app");bundle.exports.initTooltip();
