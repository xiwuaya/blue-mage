...
//# sourceURL=webpack://CafeKitCommon/./lib/styles/main.styl?`)}})},module.exports=factory()},function(e,t,n){var o,r=this&&this.__extends||(o=function(b,k){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(g,v){g.__proto__=v}||function(g,v){for(var f in v)v.hasOwnProperty(f)&&(g[f]=v[f])})(b,k)},function(b,k){function g(){this.constructor=b}o(b,k),b.prototype=k===null?Object.create(k):(g.prototype=k.prototype,new g)}),l=this&&this.__assign||function(){return(l=Object.assign||function(b){for(var k,g=1,v=arguments.length;g<v;g++)for(var f in k=arguments[g])Object.prototype.hasOwnProperty.call(k,f)&&(b[f]=k[f]);return b}).apply(this,arguments)},i=this&&this.__awaiter||function(b,k,g,v){return new(g||(g=Promise))(function(f,w){function x(q){try{j(v.next(q))}catch(A){w(A)}}function P(q){try{j(v.throw(q))}catch(A){w(A)}}function j(q){q.done?f(q.value):new g(function(A){A(q.value)}).then(x,P)}j((v=v.apply(b,k||[])).next())})},a=this&&this.__generator||function(b,k){var g,v,f,w,x={label:0,sent:function(){if(1&f[0])throw f[1];return f[1]},trys:[],ops:[]};return w={next:P(0),throw:P(1),return:P(2)},typeof Symbol=="function"&&(w[Symbol.iterator]=function(){return this}),w;function P(j){return function(q){return function(A){if(g)throw new TypeError("Generator is already executing.");for(;x;)try{if(g=1,v&&(f=2&A[0]?v.return:A[0]?v.throw||((f=v.return)&&f.call(v),0):v.next)&&!(f=f.call(v,A[1])).done)return f;switch(v=0,f&&(A=[2&A[0],f.value]),A[0]){case 0:case 1:f=A;break;case 4:return x.label++,{value:A[1],done:!1};case 5:x.label++,v=A[1],A=[0];continue;case 7:A=x.ops.pop(),x.trys.pop();continue;default:if(!(f=(f=x.trys).length>0&&f[f.length-1])&&(A[0]===6||A[0]===2)){x=0;continue}if(A[0]===3&&(!f||A[1]>f[0]&&A[1]<f[3])){x.label=A[1];break}if(A[0]===6&&x.label<f[1]){x.label=f[1],f=A;break}if(f&&x.label<f[2]){x.label=f[2],x.ops.push(A);break}f[2]&&x.ops.pop(),x.trys.pop();continue}A=k.call(b,x)}catch(F){A=[6,F],v=0}finally{g=f=0}if(5&A[0])throw A[1];return{value:A[0]?A[1]:void 0,done:!0}}([j,q])}}};Object.defineProperty(t,"__esModule",{value:!0});var s=n(0),u=n(2),_=function(b){function k(){return b!==null&&b.apply(this,arguments)||this}return r(k,b),k.prototype.componentDidMount=function(){return i(this,void 0,void 0,function(){return a(this,function(g){switch(g.label){case 0:return[4,this.getData()];case 1:return g.sent(),[2]}})})},k.prototype.componentDidUpdate=function(g){return i(this,void 0,void 0,function(){var v;return a(this,function(f){switch(f.label){case 0:if(this.props.onUpdate&&this.props.onUpdate(),g.id===this.props.id&&g.name===this.props.name&&g.jobId===this.props.jobId)return[3,4];this.setState({data:null,error:null}),f.label=1;case 1:return f.trys.push([1,3,,4]),[4,this.getData()];case 2:return f.sent(),[3,4];case 3:return v=f.sent(),this.setState({error:v}),console.error(v),[3,4];case 4:return[2]}})})},k.prototype.getData=function(){return i(this,void 0,void 0,function(){var g,v;return a(this,function(f){switch(f.label){case 0:return[4,this.getId()];case 1:return(g=f.sent())?[4,fetch(this.context.apiBaseUrl+"/Action/"+g+"?columns=Icon,Name,Description,ActionCategory.Name,ClassJob.Name,MaxCharges,Range,Cast100ms,Recast100ms,ClassJobLevel,EffectRange,ClassJobCategory.Name")]:[2];case 2:return[4,f.sent().json()];case 3:return v=f.sent(),this.setState({data:v}),[2]}})})},k.prototype.getId=function(){return i(this,void 0,void 0,function(){var g,v,f;return a(this,function(w){switch(w.label){case 0:return this.props.id&&(g=parseInt(""+this.props.id),!isNaN(g))?[2,g]:this.props.name?(v=this.context.apiBaseUrl+"/search?indexes=Action&limit=1&string="+encodeURIComponent(this.props.name)+"&filters=ClassJobLevel>0,IsPvP="+(this.props.pvp?"1":"0"),this.props.jobId&&(v=v+",ClassJobTargetID="+this.props.jobId),[4,fetch(v)]):(this.setState({error:"\u6CA1\u6709\u6307\u5B9A\u6280\u80FD\u540D\u5B57\u6216 ID\u3002"}),[2,null]);case 1:return[4,w.sent().json()];case 2:return(f=w.sent()).Results[0]?[2,f.Results[0].ID]:(this.setState({error:"\u6CA1\u6709\u627E\u5230\u6280\u80FD\u201C"+this.props.name+"\u201D\u3002"}),[2,null])}})})},k.prototype.render=function(){if(this.state.error)return s.h(u.CKBox,null,s.h(u.CKContainer,null,this.state.error));if(!this.state.data)return s.h(u.CKBox,null,s.h(u.CKContainer,null,"Loading..."));var g=this.state.data,v=g.Icon,f=g.Name,w=g.Description,x=g.ActionCategory.Name,P=g.ClassJob.Name,j=g.ClassJobCategory.Name,q=g.MaxCharges,A=g.Range,F=g.Cast100ms,C=g.Recast100ms,z=g.ClassJobLevel,V=g.EffectRange,W=P||j,D=["\u821E\u8005","\u541F\u6E38\u8BD7\u4EBA","\u5F13\u7BAD\u624B","\u673A\u5DE5\u58EB"].indexOf(W)>-1?25:3,Q=A<0?D:A,te={attrs:[]};te.attrs.push({name:"\u8303\u56F4",value:V+"m",style:"half"}),te.attrs.push({name:"\u8DDD\u79BB",value:Q+"m",style:"half"}),te.attrs.push({name:"\u4E60\u5F97\u7B49\u7EA7",value:W+" "+z+"\u7EA7",style:"half-full"}),q&&te.attrs.push({name:"\u5145\u80FD\u5C42\u6570",value:q,style:"half-full"});var ae=""+this.context.iconBaseUrl+v.replace(/^\/i/,""),se=s.h("div",{dangerouslySetInnerHTML:{__html:w.replace(/\n/g,"<br/>")}}),le=new Date().getFullYear();return s.h(u.CKBox,null,s.h("div",{style:{width:320,padding:8}},s.h(u.CKContainer,{style:{paddingBottom:0}},s.h(u.CKItemName,{name:f,rarity:0,type:x,size:"medium",iconSrc:ae})),s.h("div",{style:{paddingTop:6}},s.h(u.CKStatGroup,null,s.h(u.CKStat,{name:"\u548F\u5531\u65F6\u95F4",value:y(F)}),s.h(u.CKStat,{name:"\u590D\u5531\u65F6\u95F4",value:y(C)}))),s.h(u.CKContainer,null,se),s.h(u.CKContainer,null,s.h(u.CKAttributes,l({},te))),s.h(u.CKComment,null,s.h("p",{style:{fontSize:"9px",textAlign:"right",opacity:.6,userSelect:"none"}},this.context.hideSeCopyright?null:"\xA9 "+le+" SQUARE ENIX CO., LTD. ","Powered by"," ",s.h("a",{href:"https://ffcafe.org/?utm_source=ckitem",target:"_blank",rel:"noopener noreferrer"},"FFCafe")))))},k}(s.Component);function y(b){return b===0?"\u5373\u65F6":b/10+"\u79D2"}t.CKAction=_},function(e,t,n){var o,r=this&&this.__extends||(o=function(a,s){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(u,_){u.__proto__=_}||function(u,_){for(var y in _)_.hasOwnProperty(y)&&(u[y]=_[y])})(a,s)},function(a,s){function u(){this.constructor=a}o(a,s),a.prototype=s===null?Object.create(s):(u.prototype=s.prototype,new u)});Object.defineProperty(t,"__esModule",{value:!0});var l=n(0),i=function(a){function s(){return a!==null&&a.apply(this,arguments)||this}return r(s,a),s.prototype.getChildContext=function(){return this.props},s.prototype.render=function(){return l.h("div",null,this.props.children)},s}(l.Component);t.CKContextProvider=i},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=n(1);t.CKItem=o.CKItem;var r=n(3);t.CKAction=r.CKAction;var l=n(4);t.CKContextProvider=l.CKContextProvider;var i=n(9);t.initTooltip=i.initTooltip;var a=n(0);t.render=a.render,t.h=a.h},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0}),t.copyText=function(o){var r=document.createElement("textarea");r.value=o,r.style.width="0",r.style.height="0",r.style.opacity="0",r.style.position="absolute",document.body.appendChild(r),r.select(),document.execCommand("copy")||prompt("\u8BF7\u624B\u52A8\u590D\u5236\u4EE5\u4E0B\u5185\u5BB9",o),document.body.removeChild(r)}},function(e,t,n){var o,r=this&&this.__extends||(o=function(s,u){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(_,y){_.__proto__=y}||function(_,y){for(var b in y)y.hasOwnProperty(b)&&(_[b]=y[b])})(s,u)},function(s,u){function _(){this.constructor=s}o(s,u),s.prototype=u===null?Object.create(u):(_.prototype=u.prototype,new _)});Object.defineProperty(t,"__esModule",{value:!0});var l=n(0),i=n(8),a=function(s){function u(){var _=s!==null&&s.apply(this,arguments)||this;return _.handleHqClick=function(){_.props.onHqChange(!_.props.hq)},_.preventSelectText=function(y){y.preventDefault(),y.stopPropagation()},_}return r(u,s),u.prototype.render=function(){var _={cursor:"pointer",userSelect:"none"};return this.props.hq||(_.opacity=.2),l.h("span",{style:_,onClick:this.handleHqClick,onMouseDown:this.preventSelectText}," ",i.hqSvg)},u}(l.Component);t.HqButton=a},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=n(0);t.hqSvg=o.h("svg",{width:"12",height:"12",viewBox:"0 0 64 67",fill:"none",xmlns:"http://www.w3.org/2000/svg"},o.h("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M41.1148 9.7149C50.538 9.7149 58.8813 14.3384 64 21.4405C59.3004 8.91467 47.2153 0 33.048 0C14.7961 0 0 14.7961 0 33.048C0 51.2999 14.7961 66.0959 33.048 66.0959C34.469 66.0959 35.8691 66.0062 37.2428 65.8322C33.4767 65.3149 29.9478 64.0537 26.8091 62.2016C25.2784 60.1233 24.3739 57.5554 24.3739 54.7763C24.3739 47.854 29.9856 42.2424 36.9079 42.2424C43.4076 42.2424 48.7518 47.1898 49.3801 53.5242C50.0936 51.5602 50.4827 49.4405 50.4827 47.23C50.4827 37.0501 42.2303 28.7977 32.0504 28.7977C22.6912 28.7977 14.9612 35.7732 13.7757 44.8089C13.2197 42.5998 12.9243 40.2871 12.9243 37.9054C12.9243 22.3362 25.5456 9.7149 41.1148 9.7149Z",fill:"white"}))},function(e,t,n){var o=this&&this.__assign||function(){return(o=Object.assign||function(u){for(var _,y=1,b=arguments.length;y<b;y++)for(var k in _=arguments[y])Object.prototype.hasOwnProperty.call(_,k)&&(u[k]=_[k]);return u}).apply(this,arguments)};Object.defineProperty(t,"__esModule",{value:!0});var r=n(10),l=n(11),i=n(12),a={context:{apiBaseUrl:"https://cafemaker.wakingsands.com",iconBaseUrl:"https://cafemaker.wakingsands.com/i",defaultHq:!0,hideSeCopyright:!1},links:{detectWikiLinks:!0,itemNameAttribute:"data-ck-item-name",itemIdAttribute:"data-ck-item-id",actionNameAttribute:"data-ck-action-name",actionIdAttribute:"data-ck-action-id",rootContainer:document.body}},s=!!r.isSupportPassive()&&{passive:!0};t.initTooltip=function(u){u===void 0&&(u={});var _={context:o({},a.context,u.context||{}),links:o({},a.links,u.links||{})},y=function(b){return function(k){var g,v="item";if((b.links.itemIdAttribute||b.links.itemNameAttribute)&&(g=g||function(x,P){var j=l.closest(x,"["+P.links.itemNameAttribute+"]"),q=l.closest(x,"["+P.links.itemIdAttribute+"]");if(q)return{props:{id:q.getAttribute(P.links.itemIdAttribute)},element:q};if(j){var A=j.getAttribute(P.links.itemNameAttribute)||j.innerText.trim();return{props:{name:A},element:j}}return null}(k.target,b)),b.links.detectWikiLinks&&(g=g||function(x){var P=l.closest(x,"a");if(!P||P.host!=="ff14.huijiwiki.com")return null;var j=P.pathname.match(/^\/wiki\/(.*)$/);if(!j)return null;var q=decodeURIComponent(j[1]).split(":"),A=q[0],F=q[1];return A!=="\u7269\u54C1"&&A.toLowerCase()!=="item"?null:{props:{name:F},element:P}}(k.target)),b.links.actionIdAttribute||b.links.actionNameAttribute){var f=function(x,P){var j=l.closest(x,"["+P.links.actionNameAttribute+"]"),q=l.closest(x,"["+P.links.actionIdAttribute+"]");if(q)return{props:{id:q.getAttribute(P.links.actionIdAttribute)},element:q};if(j){var A=j.getAttribute("data-ck-action-job-id")||null,F=j.getAttribute(P.links.actionNameAttribute)||j.innerText.trim();return{props:{name:F,jobId:A},element:j}}return null}(k.target,b);f&&(v="action",g=f)}if(g&&(v==="item"?i.popupItem(b.context,g.props,g.element):i.popupAction(b.context,g.props,g.element),g.element.__ckflag_leave!==!0)){var w=function(){i.hidePopup(),g.element.removeEventListener("mouseleave",w),delete g.element.__ckflag_leave};g.element.addEventListener("mouseleave",w,s),function(x,P){x["__ckflag_"+P]=!0}(g.element,"leave")}}}(_);_.links.rootContainer.addEventListener("mouseover",y,s)}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o=null;t.isSupportPassive=function(){if(o!==null)return o;if(typeof window!="undefined"&&typeof window.addEventListener=="function"){var r=!1,l=Object.defineProperty({},"passive",{get:function(){r=!0}}),i=function(){};return window.addEventListener("testPassiveEventSupport",i,l),window.removeEventListener("testPassiveEventSupport",i,l),o=r,r}}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0}),t.closest=function(o,r){if(typeof r=="string")try{document.createElement("div").querySelector(r)}catch{return null}var l=o;do{if(r instanceof HTMLElement){if(l===r)return l}else if(l.matches(r))return l;l=l.parentElement}while(l);return null}},function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var o,r,l=n(0),i=n(1),a=n(3),s=n(4),u=document.createElement("div");u.style.position="fixed",u.style.display="none",u.className="cafekit ck-popup";var _=function(){setTimeout(b,100)};function y(){clearTimeout(o),o=setTimeout(function(){return u.style.display="none"},300)}function b(){var g=r.getBoundingClientRect(),v=window.innerWidth,f=window.innerHeight,w=u.getBoundingClientRect(),x={left:g.right+15,top:g.bottom+10,bottom:void 0},P=w.width,j=w.height;for(var q in x.left+P>v&&(x.left=Math.max(0,v-P)),x.top+j>f&&(x.top=void 0,x.bottom=10),x)u.style[q]=x[q]==null?"":x[q]+"px"}function k(g){r=g;var v=u;b(),v.style.display="block",v.parentElement||document.body.appendChild(v)}t.popupItem=function(g,v,f){clearTimeout(o),v.onUpdate=_,l.render(l.h(s.CKContextProvider,g,[l.h(i.CKItem,v)]),u,u.children&&u.children[0]),k(f)},t.popupAction=function(g,v,f){clearTimeout(o),v.onUpdate=_,l.render(l.h(s.CKContextProvider,g,[l.h(a.CKAction,v)]),u,u.children&&u.children[0]),k(f)},t.hidePopup=y,u.addEventListener("mouseenter",function(){return clearTimeout(o)}),u.addEventListener("mouseleave",function(){return y()})}])})})(bundle);createApp(App).mount("#app");bundle.exports.initTooltip();
